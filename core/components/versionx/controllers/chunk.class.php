...
class VersionXChunkManagerController extends VersionXBaseManagerController {
    public $targetClass = 'vxChunk';
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/chunks/detailpanel.chunks.js' . $cachebust);
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/chunks/combo.versions.chunks.js' . $cachebust);
