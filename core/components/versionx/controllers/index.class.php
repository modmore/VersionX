...
class VersionXIndexManagerController extends modExtraManagerController {
    ...
    public function process(array $scriptProperties = array())
    {
        ...
        switch ($_REQUEST['action']) {
            case 'resource':
                ...
                if ($versionid > 0) {
                    ...
                    if ($v !== false) {
                        $this->modx->regClientStartupHTMLBlock('<script type="text/javascript">VersionX.record = ' . $v . '; </script>');
                    }
                }
                ...
                if ($compareid > 0) {
                    ...
                    if ($v !== false) {
                        $this->modx->regClientStartupHTMLBlock('<script type="text/javascript">VersionX.cmrecord = ' . $v . '; </script>');
                    }
                }
            ...
            case 'template':
                ...
                if ($versionid > 0) {
                    ...
                    if ($v !== false) {
                        $this->modx->regClientStartupHTMLBlock('<script type="text/javascript">VersionX.record = ' . $this->modx->toJSON($v) . '; </script>');
                    }
                }
                /* If an ID to compare to was passed, fetch that aswell. */
                if ($compareid > 0) {
                    ...
                    if ($v !== false) {
                        $this->modx->regClientStartupHTMLBlock('<script type="text/javascript">VersionX.cmrecord = ' . $this->modx->toJSON($v) . '; </script>');
                    }
                }
        ...
        $this->modx->regClientStartupHTMLBlock($scriptTags);
