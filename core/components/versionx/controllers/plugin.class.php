...
class VersionXPluginManagerController extends VersionXBaseManagerController {
    public $targetClass = 'vxPlugin';
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/plugins/detailpanel.plugins.js' . $cachebust);
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/plugins/combo.versions.plugins.js' . $cachebust);
