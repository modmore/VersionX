...
class VersionXSnippetManagerController extends VersionXBaseManagerController {
    public $targetClass = 'vxSnippet';
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/snippets/detailpanel.snippets.js' . $cachebust);
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/snippets/combo.versions.snippets.js' . $cachebust);
