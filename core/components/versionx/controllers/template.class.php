...
class VersionXTemplateManagerController extends VersionXBaseManagerController {
    public $targetClass = 'vxTemplate';
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/templates/detailpanel.templates.js' . $cachebust);
        $this->addJavascript($this->versionx->config['js_url'] . 'mgr/templates/combo.versions.templates.js' . $cachebust);
