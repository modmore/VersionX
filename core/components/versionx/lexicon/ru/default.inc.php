...
$_lang['versionx.common.version-details'] = 'Детали версии';
...
$_lang['versionx.chunks.detail.tabs.fields'] = 'Поля';
$_lang['versionx.chunks.detail.tabs.content'] = 'Содержимое';
$_lang['versionx.chunks.detail.tabs.properties'] = 'Свойства';
$_lang['versionx.chunks.detail.tabs.properties.off'] = 'К сожалению, мы еще не можем показать вам эту вкладку';
$_lang['versionx.chunks.detail'] = 'Детали шаблона';
$_lang['versionx.chunks.detail.text'] = 'Ниже вы можете найти подробности для версии шаблона, которую вы выбрали. Для сравнения этой версии с другой используйте выпадающий список ниже, чтобы выбрать другую версию.';
